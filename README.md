...
- Proficient with Python, C, C++, and Mathematica
- Proficient with Linux, git, bash, slurm
- Experience with scikit-learn for regression and classification
- Experience with keras for neural network implementation
